const StatusData = {
    data: [
        { image: require('../Assets/img1.jpg'), borderColor: 'red', id: 0 },
        ...
        { image: require('../../assets/gallery2.jpeg'), borderColor: 'skyblue', id: 7 },
        { image: require('../../assets/tamil1.jpg'), borderColor: 'white', id: 8 },
    ],
    stories: [
        {
            name: 'Your Story',
            image: require('../../assets/chat4.jpg')
        },
        {
            name: 'shadman@_96',
            image: require('../../assets/chat2.jpg')
        },
        {
            name: 'Shaanay_45@',
            image: require('../../assets/chat3.jpg')
        },
        {
            name: 'Dating@_23',
            image: require('../../assets/chat4.jpg')
        ...
        {
            name: 'ALka_laka21',
            image: require('../../assets/chat5.jpg')
        },
        {
            name: 'store.Enappd_2019',
            image: require('../../assets/chat6.jpg')
        },
        {
            name: 'Akas_Motwami@2',
            image: require('../../assets/chat7.jpg')
        },
        {
            name: 'md_sadman96',
            image: require('../../assets/chat8.jpg')
        },
        {
    ...
    cards: [
        {
            avatar: require('../../assets/chat5.jpg'),
            name: 'store_enappd',
            subname: 'Web_&_app services provider.',
            likes: '813',
            info: 'A platform where you can buy apps as per your needs at a very economical price.we provide you the best.',
            days: '1 hours ago',
        ...
        {
            avatar: require('../../assets/chat5.jpg'),
            image: require('../../assets/chat1.jpg'),
            name: 'md_shadman',
            subname: 'Malviya Nagar, Jaipur',
            views: '2,131,12',
            days: '2 hours ago',
            info: 'A platform where you can buy apps as per your needs at a very economical price.we provide you the best.',
        },
